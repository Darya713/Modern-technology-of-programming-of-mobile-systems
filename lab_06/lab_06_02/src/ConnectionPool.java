...
class Client extends Thread {
    ...
    public void run()
    {
        ...
        try { connect  =  pool.getResource(500);
            reading  =  true;
            System.out.println("Соединение с клиентом № " + this.getId() + " ... трубку взял оператор №" + connect.getConnectID());
        ...
        catch (Exception e)
        {
            ...
            if (connect != null)
            {
                reading  =  false; System.out.println("Клиент № " + this.getId() + " повесил трубку");
